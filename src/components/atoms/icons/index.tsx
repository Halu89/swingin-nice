...
export type Icon = (props: { className: string }) => React.ReactNode;
...
export const CircleDashedIcon: Icon = (props) => (
    <svg
        {...props}
...
export const PartyPopperIcon: Icon = (props) => {
    return (
        <svg
            {...props}
            xmlns="http://www.w3.org/2000/svg"
...
export const WorkflowIcon: Icon = (props) => {
    return (
        <svg
            {...props}
            xmlns="http://www.w3.org/2000/svg"
